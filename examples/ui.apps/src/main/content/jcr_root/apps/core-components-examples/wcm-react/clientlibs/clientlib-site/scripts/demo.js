...
(function(Promise, Prettify, htmlBeautify) {
    ...
    var selectors = {
        self: '[data-cmp-react-examples-is="demo"]',
        info: '[data-cmp-react-examples-hook-demo="info"]',
        json: '[data-cmp-react-examples-hook-demo="json"]',
        jsonLink: '[data-cmp-react-examples-hook-demo="jsonLink"]',
        markup: '[data-cmp-react-examples-hook-demo="markup"]',
        hideCode: '[data-cmp-react-examples-hook-demo="hideCode"]',
        showCode: '[data-cmp-react-examples-hook-demo="showCode"]',
        copyCode: '[data-cmp-react-examples-hook-demo="copyCode"]',
        ...
        demos.forEach(function(demo) {
            ...
            if (hideCode) {
                hideCode.addEventListener('click', function() {
                    info.classList.remove('cmp-react-examples-demo__info--open');
            ...
            if (showCode) {
                showCode.addEventListener('click', function() {
                    info.classList.add('cmp-react-examples-demo__info--open');
