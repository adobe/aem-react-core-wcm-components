...
(function() {
    ...
    var selectors = {
        self: '[name="cmp-react-examples-component-search"]',
        componentGroup: '.cmp-react-examples-container--component-group',
        componentTeaser: '.cmp-react-examples-teaser--component',
        noResults: '.cmp-react-examples-text--no-results'
    };
