...
(function() {
    ...
    var selectors = {
        self: '.cmp-react-examples-structure__aside',
        showMenu: '[data-cmp-react-examples-is="showMenu"]'
    };

    var cssClasses = {
        open: 'cmp-react-examples-structure__aside--open',
        mask: {
            self: 'cmp-react-examples-mask',
            open: 'cmp-react-examples-mask--open'
        }
    };
