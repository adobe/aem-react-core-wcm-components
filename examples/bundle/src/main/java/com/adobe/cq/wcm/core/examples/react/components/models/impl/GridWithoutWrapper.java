...
@Model(
        ...
        resourceType = {GridWithoutWrapper.RESOURCE_TYPE}
)
@Exporter(name = "jackson", selector = "model", extensions = {"json"})
@JsonSerialize(as = ResponsiveGridExporter.class)
public class GridWithoutWrapper extends ResponsiveGrid {
    
    static final String RESOURCE_TYPE = "core-components-examples/wcm/react/components/grid-without-wrapper";
