...
export const TitleV2Link = (props: TitleV2Model) : JSX.Element => {
    return (
...
export const TitleV2Contents = (props: TitleV2Model) : JSX.Element => {
...
const TitleV2 = (props: TitleV2Model) : JSX.Element => {
