...
export const LanguageNavigationV1Link = (props: LanguageNavigationV1Item): JSX.Element => {
    if (props.level > 0) {
        return (
          <RoutedLink
...
export const LanguageNavigationV1Group = (item: LanguageNavigationV1Item): JSX.Element => {
    return (
      <>
...
export const LanguageNavigationV1Item = (item: LanguageNavigationV1Item): JSX.Element => {
...
const LanguageNavigation = (props: LanguageNavigationV1Model): JSX.Element => {
    const Wrapped = withConditionalPlaceHolder(
        withStandardBaseCssClass(LanguageNavigationV1Impl, 'cmp-languagenavigation'),
        LanguageNavigationV1IsEmptyFn, 'LanguageNavigation V1');
