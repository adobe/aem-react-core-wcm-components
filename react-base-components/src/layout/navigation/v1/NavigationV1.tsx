...
export const determineIsActive = (item: NavigationV1Item): boolean => {
    return item.active;
};

export const NavigationV1Group = (item: NavigationV1Item): JSX.Element => {
    return (
      <>
...
export const NavigationV1Item = (item: NavigationV1Item): JSX.Element => {
...
export const NavigationV1Impl = (props: NavigationV1Model): JSX.Element => {
...
export const NavigationV1 = (props: NavigationV1Model): JSX.Element => {
    // eslint-disable-next-line no-redeclare
